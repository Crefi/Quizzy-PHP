        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="flex justify-between items-center">
                    ...
                    <a class="text-white text-xl px-5" href="questions?quiz_id={{ quiz.id }}&experience_points={{ quiz.experience_points }}&passing_limit={{ quiz.passing_limit }}">                        <button style="background-color: #007074; margin-left: 1rem;"
